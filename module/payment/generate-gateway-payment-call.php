...
if (isset($_POST['save_btn4'])) { 
  ...
  $some_data = array(
    ...
    'billPayorInfo' => 1,
    'billAmount' => $rmx100,
    'billReturnUrl' => 'https://prodigystudio.test/controller/manageEventController.php?page=finished&eid=' . $event_id . '&title=' . $title . '&price=' . $harga,
    'billCallbackUrl' => '',
...
if (isset($_POST['ticket_btn'])) {
  ...
  $some_data = array(
    ...
    'billPayorInfo' => 1,
    'billAmount' => $rmx100,
    'billReturnUrl' => 'https://prodigystudio.test/controller/viewEventController.php?page=finished&eid=' . $event_id . '&title=' . $title . '&price=' . $harga*$quantity_input.'&username='.$username.'&quantity='.$quantity .'&quantity_left='.$quantity_left.'&quantity_input='.$quantity_input,
    'billCallbackUrl' => '',
    'billExternalReferenceNo' => '',
    'billTo' => $nama,
    'billEmail' => $email,
