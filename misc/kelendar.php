...
for ($day = 1; $day <= $day_count; $day++, $str++) {
    ...
    if ($today == $date) {
        $week .= '<td class="border p-1 h-40 xl:w-40 lg:w-30 md:w-30 sm:w-20 w-10 overflow-auto transition cursor-pointer duration-500 ease hover:bg-gray-300 ">' ."<span class='text-gray-500'>".$day."</span>";
    } else {
...
<body>
    <h1 class="text-center text-2xl">Event Schedule</h1>
