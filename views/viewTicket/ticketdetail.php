        ...
        <div class="max-w-md mx-auto flex">
            <div class="divide-y divide-gray-300/50 relative right-36">
                <div class="py-8 text-base leading-7 space-y-6 text-gray-600 w-96">
                    <h1 class="text-2xl"><b>Lepak Sanggaq</b></h1>
                    <hr>
                    <h2 class="text-base"><b>Event time and date: </b>8.00p.m. , 22/1/2022</h2>
                    <h2 class="text-base"><b>Venue: </b>Prodigy Studio, Sangkar Seni</h2>
                    <h2 class="text-base"><b>Admission fee: </b> RM 15 </h2>
